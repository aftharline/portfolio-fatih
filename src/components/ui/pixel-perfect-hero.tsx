...
const BRAND_LOGOS = [
  ...
  () => (
    <svg className="h-[14px] sm:h-[18px] fill-foreground/75 dark:fill-foreground/80 select-none opacity-60 hover:opacity-100 transition-opacity duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394 79">
  ...
  () => (
    <svg className="h-[24px] sm:h-[32px] select-none opacity-60 hover:opacity-100 transition-opacity duration-300" version="1.1" viewBox="-45.101 -44.95 390.872 269.7">
      <g transform="translate(-1.668 -1.1)">
        ...
        <g>
          <path d="M273.5 143.7c-32.9 24.3-80.7 37.2-121.8 37.2-57.6 0-109.5-21.3-148.7-56.7-3.1-2.8-.3-6.6 3.4-4.4 42.4 24.6 94.7 39.5 148.8 39.5 36.5 0 76.6-7.6 113.5-23.2 5.5-2.5 10.2 3.6 4.8 7.6" className="fill-[#f90]" />
...
export function PixelHero({
  ...
  useEffect(() => {
    ...
    setThemeColors(['#a1a1aa', '#71717a', '#52525b', '#3f3f46', '#e4e4e7']);
  ...
  return (
    // UBAH LAYOUT: Pakai justify-center dan atur gap biar ngumpul elegan di tengah
    <div className="relative w-full min-h-[100dvh] flex flex-col justify-center items-center gap-6 sm:gap-8 py-20 px-4 sm:px-6 overflow-hidden select-none isolate">
      <style>{`
        @keyframes marquee {
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-40">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#09090b_100%)] pointer-events-none opacity-80" />
      </div>

      {/* Top Container: Tahoe Glass Header */}
      <div className="flex flex-col items-center justify-center text-center w-full z-10 pointer-events-none">
        <h1 className="tahoe-glass-text flex flex-row items-center justify-center gap-2 sm:gap-4 lg:gap-6 px-1 w-full flex-wrap text-[3.2rem] xs:text-[3.8rem] sm:text-6xl md:text-8xl lg:text-9xl leading-none">
      ...
      <div className="flex flex-col items-center justify-center text-center w-full z-10 pointer-events-none mt-2 md:mt-4">
        <p className="text-sm sm:text-base md:text-xl font-light text-zinc-400 max-w-[90%] sm:max-w-md md:max-w-2xl leading-relaxed">
          {description}
        </p>

        {/* LOGO MOBILE MARQUEE (COMMENTED OUT) 
        <div className="block md:hidden w-full mt-12 pointer-events-auto">
          <div className="text-[11px] uppercase tracking-wider text-zinc-600 font-medium mb-5">
...
{/* Bottom Container: CTA Row */}
      <div
        className={cn("pointer-events-auto flex flex-row items-center justify-center gap-3 mt-6 md:mt-8 z-10 transition-all duration-1000 transform px-1", isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}
        style={{ transitionDelay: "450ms" }}
      >
        {/* Ganti Button ke A tag untuk navigasi scroll yang native */}
        <a 
          href="#projects-container" 
          className="relative inline-flex h-10 md:h-12 items-center justify-center gap-1.5 md:gap-2 rounded-xl bg-white px-5 md:px-8 text-xs md:text-sm font-bold text-black shadow-[0_0_20px_rgba(255,255,255,0.2)] transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
        >
        ...
        <a 
          ...
          className="relative inline-flex h-10 md:h-12 items-center justify-center gap-1.5 md:gap-2 rounded-xl bg-zinc-900/80 px-5 md:px-8 text-xs md:text-sm font-semibold text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] ring-1 ring-white/10 backdrop-blur-md transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer hover:bg-zinc-800"
        >
      ...
      {/* LOGO DESKTOP MARQUEE (COMMENTED OUT)
      <div
      ...
      >
        <span className="text-xs uppercase tracking-wider text-zinc-600 font-medium select-none">
          Trusted by industry leaders
        </span>
